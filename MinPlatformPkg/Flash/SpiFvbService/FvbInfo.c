  ...
  )
{
  ...
  TotalNvVariableStorageSize =  (UINT64)PcdGet32 (PcdFlashNvStorageVariableSize) +
  ...
  FvbMediaInfo->BaseAddress = (EFI_PHYSICAL_ADDRESS)PcdGet32 (PcdFlashNvStorageVariableBase);
